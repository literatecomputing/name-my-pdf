...
- **Download DMG**: [NameMyPdf-v0.9.31.dmg](https://github.com/literatecomputing/name-my-pdf/releases/download/v0.9.31/NameMyPdf-v0.9.31.dmg)
- **Download ZIP**: [NameMyPdf-v0.9.31.zip](https://github.com/literatecomputing/name-my-pdf/releases/download/v0.9.31/NameMyPdf-v0.9.31.zip)
<!-- VERSION-UPDATE-END -->
